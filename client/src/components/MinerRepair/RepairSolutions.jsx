  ...
  return (
    <div className="bg-homeBg px-5 md:px-10 xl:px-[120px] py-10 text-center flex flex-col justify-center items-center gap-10">
      ...
      <p className="text-base font-medium text-white leading-6 max-w-[1100px] mb-10">
        ...
        Program, combined with in-depth Tutorials and Guides, offers the perfect
        blend of theoretical knowledge and practical experience. From beginners
        to advanced practitioners, our materials are designed to help you
        troubleshoot, maintain, and optimize your mining equipment with ease.
      </p>
    </div>
  );
}
